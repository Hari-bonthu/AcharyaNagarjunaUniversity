...
import { $ as Route$b, Y as getResearchTab, Z as researchTabs } from "./router-Dtgf3qry.mjs";
...
function ResearchShell({ pageId, children }) {
  const activeTab = getResearchTab(pageId);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "research-root pb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "research-masthead py-8 text-center text-white lg:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-4xl px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-playfair text-3xl font-bold tracking-tight md:text-5xl", children: "Research & Development" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-garamond mx-auto mt-6 max-w-2xl text-lg italic tracking-wide text-[var(--gold-light)] md:text-xl", children: '"Pioneering innovation, doctoral studies, technology transfer, and business incubation."' })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1400px] px-6 py-8 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-10 lg:grid-cols-[300px_1fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-full lg:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:sticky lg:top-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "sidebar-menu", "aria-label": "Research Navigation", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-lg font-bold text-[var(--ink)]", children: "Research Directory" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${isMenuOpen ? "flex" : "hidden"} lg:flex flex-col`, children: researchTabs.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: `/research/${item.key}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-w-0 pb-8", id: "research-content", children: [
          children,
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 rounded border border-[var(--gold)]/30 bg-[var(--gold)]/5 p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-2xl font-bold text-[var(--ink)]", children: "R&D Office Support" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif mt-2 text-lg text-[var(--muted)]", children: "Need clearances for sponsored grants, project fellow recruitment, or patent filing applications?" })
            ] }),
...
function ResearchPageComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResearchShell, { pageId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResearchApp, { page: pageId, onPageChange: handlePageChange }) });
}
export {
  ResearchPageComponent as component
};

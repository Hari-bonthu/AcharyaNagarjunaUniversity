...
import { a2 as Route$a, a0 as getRankingsTab, a1 as rankingsTabs } from "./router-Dtgf3qry.mjs";
...
function RankingsShell({ pageId, children }) {
  const activeTab = getRankingsTab(pageId);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rankings-root pb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rankings-masthead py-8 text-center text-white lg:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-4xl px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-playfair text-3xl font-bold tracking-tight md:text-5xl", children: "Rankings & Accreditations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-garamond mx-auto mt-6 max-w-2xl text-lg italic tracking-wide text-[var(--gold-light)] md:text-xl", children: '"Upholding institutional quality, global benchmarks, and academic excellence."' })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1400px] px-6 py-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        BreadcrumbTrail,
        {
          items: [
            { label: "Home", href: "/" },
            { label: "Rankings", href: "/rankings/overview" },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1400px] px-6 py-8 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-10 lg:grid-cols-[300px_1fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-full lg:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:sticky lg:top-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "sidebar-menu", "aria-label": "Rankings Navigation", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-lg font-bold text-[var(--ink)]", children: "Rankings Directory" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${isMenuOpen ? "flex" : "hidden"} lg:flex flex-col`, children: rankingsTabs.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: `/rankings/${item.key}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-w-0 pb-8", id: "rankings-content", children: [
          children,
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 rounded border border-[var(--gold)]/30 bg-[var(--gold)]/5 p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-2xl font-bold text-[var(--ink)]", children: "IQAC Support Desk" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif mt-2 text-lg text-[var(--muted)]", children: "Have questions about rankings datasets, self-study audit reports, or AQAR submission cycles?" })
            ] }),
...
function RankingsPageComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RankingsShell, { pageId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RankingsApp, { page: pageId, onPageChange: handlePageChange }) });
}
export {
  RankingsPageComponent as component
};

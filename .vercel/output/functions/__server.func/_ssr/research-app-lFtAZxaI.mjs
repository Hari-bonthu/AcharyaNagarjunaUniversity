...
import { Y as getResearchTab } from "./router-Dtgf3qry.mjs";
function ResearchContent({ tab }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border border-[var(--rule)] bg-white shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
      ...
      tab.notices && tab.notices.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair mb-6 text-2xl font-bold text-[var(--ink)]", children: "Research Notices" }),
      ...
      tab.steps && tab.steps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair mb-6 text-2xl font-bold text-[var(--ink)]", children: "Action Steps & Protocols" }),
      ...
      tab.resources && tab.resources.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair mb-6 text-2xl font-bold text-[var(--ink)]", children: "Forms & Guidelines" }),
          ...
          const inner = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full flex-col justify-between rounded border border-[var(--rule)] bg-[var(--parchment)] p-6 transition-colors hover:border-[var(--gold)]/50 hover:bg-white group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2 font-serif text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-[var(--ink)] min-w-[100px]", children: "Office:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--muted)]", children: resource.channel })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-[var(--ink)] min-w-[100px]", children: "Timeline:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--muted)]", children: resource.turnaround })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-[var(--ink)] min-w-[100px]", children: "Prerequisites:" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border border-[var(--ink)]/10 bg-[var(--ink)] p-8 text-white", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-2xl font-bold", children: "Research Guide Information" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-8 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm font-semibold uppercase tracking-wider text-[var(--gold-light)]", children: "Office Hours" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif mt-2", children: tab.supportPanel.availability })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm font-semibold uppercase tracking-wider text-[var(--gold-light)]", children: "Average Clearances" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid gap-8 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm font-semibold uppercase tracking-wider text-[var(--gold-light)]", children: "Guidelines & Ethics" }),
...
function ResearchApp({
  ...
  const activeTab = reactExports.useMemo(() => getResearchTab(page), [page]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-page-root res-page-bg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "res-hero mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "res-hero-rule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-12 md:px-14 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "res-hero-title mt-3", children: activeTab.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "res-hero-desc", children: activeTab.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "res-tabs-row", children: activeTab && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: heroStats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-stat-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "res-stat-value", children: s.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "res-stat-label", children: s.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "res-stat-note", children: s.note })
          ] }, s.label))
        }
      ),
      activeTab.key === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "res-section-label", children: "Guiding Principles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "res-section-heading", children: [
          "Intellectual Stewardship & ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Academic Innovation" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "res-divider-rule", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✦" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-[1.25fr_0.75fr]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "res-identity-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-identity-prose", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Acharya Nagarjuna University is committed to fostering academic research, scholarly investigations, and technology transfers. Through our central R&D cell, doctoral studies committee, and IPR department, we coordinate dozens of funded projects, draft patents, and provide resources for research scholars and faculty." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Our research policy promotes highest academic standards, zero tolerance for plagiarism, and collaboration with global research networks. Faculty and students are encouraged to publish in indexed, high-impact journals under verified ethical frameworks." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Additionally, the university provides incubation spaces, mentoring support, and technology transfer options to bridge the gap between academic innovation and market readiness." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "blockquote",
              {
                style: {
                ...
                children: '"Empowering innovators, doctoral scholars, and academic leaders to expand global scientific boundaries."'
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-pillars-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                style: {
                ...
                children: "Research Vision"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "res-pillars-title", children: "Core Anchors" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "1.25rem" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "res-pillars-icon", children: "◈" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Funding & Labs" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Securing central grants from DST, UGC, DBT, and CSIR to build specialized research centers." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "res-pillars-icon", children: "✦" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Ethical Compliance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Auditing synopsis dossiers and thesis files using verified anti-plagiarism networks." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "res-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "res-pillars-icon", children: "❖" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Incubation & Transfer" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Filing international patents and commercializing prototypes inside student start-up cells." })
              ] })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResearchContent, { tab: activeTab }) })
    ] })
  ] });
}
export {

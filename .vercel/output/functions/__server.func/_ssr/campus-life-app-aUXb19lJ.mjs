...
import { a9 as getCampusLifeTab } from "./router-Dtgf3qry.mjs";
function CampusLifeContent({ tab }) {
...
function CampusLifeApp({
  page,
  onPageChange
}) {
  const activeTab = reactExports.useMemo(() => getCampusLifeTab(page), [page]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-page-root cam-page-bg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cam-hero mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cam-hero-rule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-12 md:px-14 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "cam-hero-title mt-3", children: activeTab.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cam-hero-desc", children: activeTab.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cam-tabs-row", children: activeTab && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: heroStats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-stat-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cam-stat-value", children: s.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cam-stat-label", children: s.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cam-stat-note", children: s.note })
          ] }, s.label))
        }
      ),
      activeTab.key === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cam-section-label", children: "Guiding Principles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "cam-section-heading", children: [
          "Active Community & ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Holistic Development" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cam-divider-rule", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✦" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-[1.25fr_0.75fr]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cam-identity-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-identity-prose", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Acharya Nagarjuna University offers a comprehensive, vibrant campus ecosystem designed to support student life beyond classrooms. From residential hostels with cooperative dining to state-of-the-art sports playfields, our facilities help students maintain fitness, construct lifelong networks, and build leadership skills." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We actively encourage civic engagement and national pride through our NSS, NCC, and Electoral Literacy chapters. By adopting local villages, participating in parade drills, or launching voter registration drives, students build active responsibility." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Whether you are an outpatient checking services at the 24/7 Health Centre, recording educational radio scripts, or exploring biology at the Botanical Gardens, this module presents your guides, forms, and official points of contact." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "blockquote",
              {
                style: {
                ...
                children: '"Fostering active student responsibility, health, and leadership across a green, sustainable campus."'
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-pillars-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                style: {
                ...
                children: "Campus Vision"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "cam-pillars-title", children: "Core Anchors" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "1.25rem" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cam-pillars-icon", children: "◈" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Wellness & Safety" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Round-the-clock medical care, emergency evacuations, residential security, and safe hostelling." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cam-pillars-icon", children: "✦" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Leadership & Service" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Active character building via militarized drill units, NSS blood drives, and electoral literacy camps." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-pillars-item", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cam-pillars-icon", children: "❖" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Creative Engagement" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Broadcasting on 91.2 FM, joining active sports, botanical indexing, and cultural convocations." })
              ] })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CampusLifeContent, { tab: activeTab }) })
    ] })
  ] });
}
export {

...
import type { RankingsTab } from "@/data/rankings-app";

export function RankingsContent({ tab }: { tab: RankingsTab }) {
  return (
    <div className="rounded border border-[var(--rule)] bg-white shadow-sm">
      ...
      <div className="p-8">
        ...
        <div className="rounded border border-[var(--ink)]/10 bg-[var(--ink)] p-8 text-white">
          <h3 className="font-playfair text-2xl font-bold">Verification Desk Guide</h3>

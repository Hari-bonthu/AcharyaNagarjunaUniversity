...
import { rankingsTabs, getRankingsTab } from "@/data/rankings-app";

export function RankingsShell({ pageId, children }: { pageId: string; children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="rankings-root pb-12">
        <div className="rankings-masthead py-8 text-center text-white lg:py-12">
          <div className="relative z-10 mx-auto max-w-4xl px-6">
            ...
            <p className="font-garamond mx-auto mt-6 max-w-2xl text-lg italic tracking-wide text-[var(--gold-light)] md:text-xl">
              "Upholding institutional quality, global benchmarks, and academic excellence."
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-6 lg:px-8">
          <BreadcrumbTrail
            items={[
              { label: "Home", href: "/" },
              { label: "Rankings", href: "/rankings/overview" as any },
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[300px_1fr]">
            <aside className="w-full lg:w-auto">
              <div className="lg:sticky lg:top-24">
                <nav className="sidebar-menu" aria-label="Rankings Navigation">
                  <button
                    type="button"
                  ...
                  <div className={`${isMenuOpen ? "flex" : "hidden"} lg:flex flex-col`}>
                    {rankingsTabs.map((item) => (
                      <Link
                        key={item.key}
                        to={`/rankings/${item.key}` as any}
            ...
            <main className="min-w-0 pb-8" id="rankings-content">
              {children}
                ...
                <div className="flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
                  <div>
                    ...
                    <p className="font-serif mt-2 text-lg text-[var(--muted)]">
                      Have questions about rankings datasets, self-study audit reports, or AQAR
                      submission cycles?
                    </p>
                  </div>

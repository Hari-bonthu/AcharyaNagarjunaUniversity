...
import { researchTabs, getResearchTab } from "@/data/research-app";

export function ResearchShell({ pageId, children }: { pageId: string; children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="research-root pb-12">
        <div className="research-masthead py-8 text-center text-white lg:py-12">
          <div className="relative z-10 mx-auto max-w-4xl px-6">
            ...
            <p className="font-garamond mx-auto mt-6 max-w-2xl text-lg italic tracking-wide text-[var(--gold-light)] md:text-xl">
              "Pioneering innovation, doctoral studies, technology transfer, and business
              incubation."
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-6 lg:px-8">
          <BreadcrumbTrail
            items={[
              { label: "Home", href: "/" },
              { label: "Research", href: "/research/overview" as any },
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[300px_1fr]">
            <aside className="w-full lg:w-auto">
              <div className="lg:sticky lg:top-24">
                <nav className="sidebar-menu" aria-label="Research Navigation">
                  <button
                    type="button"
            ...
            <main className="min-w-0 pb-8" id="research-content">
              {children}
                ...
                <div className="flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
                  <div>
                    ...
                    <p className="font-serif mt-2 text-lg text-[var(--muted)]">
                      Need clearances for sponsored grants, project fellow recruitment, or patent
                      filing applications?
                    </p>
                  </div>

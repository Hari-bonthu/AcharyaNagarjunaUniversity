...
import type { ResearchTab } from "@/data/research-app";

export function ResearchContent({ tab }: { tab: ResearchTab }) {
  return (
    <div className="rounded border border-[var(--rule)] bg-white shadow-sm">
      ...
      <div className="p-8">
        ...
        <div className="rounded border border-[var(--ink)]/10 bg-[var(--ink)] p-8 text-white">
          <h3 className="font-playfair text-2xl font-bold">Research Guide Information</h3>
